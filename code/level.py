		...
		for row_index, row in enumerate(layout):
			for col_index,val in enumerate(row):
				if val != '-1':
					...
					if type == 'terrain':
						terrain_tile_list = import_cut_graphics('../graphics/terrain/terrain_tile.png')
					...
					if type == 'coins':
						if val == '0': sprite = Coin(tile_size,x,y,'../graphics/coins/blue',1)
						if val == '1': sprite = Coin(tile_size,x,y,'../graphics/coins/red',5)
					
					if type == 'trees':
						tree_tile_list = import_cut_graphics('../graphics/terrain/terrain_tile.png')
